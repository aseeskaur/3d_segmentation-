...
def save_checkpoint(epoch, model, optimizer, best_val_loss, running_loss_list, is_best=False):
    ...
    # Save best model
    if is_best:
        best_model_path = os.path.join(CHECKPOINT_DIR, 'best_3d_model_fixed_padding.pth')
...
train_image_padded = np.pad(train_image_swap, 
                           pad_width=((40, 40), (40, 40), (5, 5)), 
                           mode='constant')
train_mask_padded = np.pad(train_mask_swap, 
                          pad_width=((40, 40), (40, 40), (5, 5)), 
                          mode='constant')
...
val_image_padded = np.pad(val_image_swap, 
                           pad_width=((40, 40), (40, 40), (5, 5)), 
                           mode='constant')
val_mask_padded = np.pad(val_mask_swap, 
                          pad_width=((40, 40), (40, 40), (5, 5)), 
                          mode='constant')
